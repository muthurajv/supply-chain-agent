"""Unit tests for the Inventory Agent."""
...
@pytest.mark.asyncio
async def test_inventory_agent_above_safety_stock(sample_state):
    mock_inv = {
        "material_id": "M-1042", "description": "Precision Ball Screw 16mm",
        "plant": "P001", "on_hand_qty": 220.0, "safety_stock": 150.0,
        "unit": "EA", "last_updated": "2024-01-15T00:00:00",
    }
...
@pytest.mark.asyncio
async def test_inventory_agent_below_safety_stock(sample_state):
    mock_inv = {
        "material_id": "M-1042", "description": "Precision Ball Screw 16mm",
        "plant": "P001", "on_hand_qty": 100.0, "safety_stock": 150.0,
        "unit": "EA", "last_updated": "2024-01-15T00:00:00",
    }
    mock_locations = []
